...
$(document).ready(function() {
  ...
  map.on('load', function() {
      ...
      map.on('click', 'place-points', function (e) {
            ...
            var coordinates = e.features[0].properties.location;
            //console.log(coordinates);
            e.features[0].geometry.coordinates.slice();
            //coordinates[0] - longitude; coordinates[1] - latitude

            renderCard(name,imgURL,detailLink,coordinates, postcode);
...
function renderCard(name,imgURL,link,coordinates, postcode){


  newCardTitle = name;

  newCardText = coordinates[0].toFixed(4)+', '+ coordinates[1].toFixed(4) +'&emsp;'+ postcode;
  // four spaces
